...
function Vacancies() {
    ...
    return (
      <>
        <div className='searchBox' text-align="center">
          <h3 className='vacanciesTitle' style={{ textAlign: "center", fontWeight: "bold", fontStyle: "italic" }}><u>Vacancies</u></h3>
          <input type="text" placeholder="Search for a job" style={{ width: "100%" }} ></input>
  ...
  const VacanciesCard = () => {
    return (
      <>
        <div class="column"
          style={{ borderStyle: "solid", borderWidth: "1px", borderRadius: "3%", padding: "20px", width: "17%" }}>
          ...
          <button style={{ marginTop: "10px" }} id="myBtn" onClick={togglePopup}>Find out more</button>
        </div>
      </>
    )
  }
