        ...
        <div className="row" >
          ...
          <h2>
            ...
            <b>
              ...
              <h2>
                <a href={filterFunction().companyWebsite} class="company-Profile" style={{ marginLeft: "20px" }}>Company website</a>
              </h2>
              <h3 style={{
              ...
              }} ><u>Location:</u> {filterFunction().vacancies[0].location} </h3>
        ...
        <div className="row">
          ...
          >
            <div style={{ marginBottom: "20px", }}>
              ...
              <h3 style={{ marginTop: "10px", marginBottom: "10px", }}>{filterFunction().vacancies[0].jobTitle}</h3>

              <div className="compDesc">
                <p style={{ marginTop: "10px", }}>{filterFunction().vacancies[0].jobDescription}</p>
              </div>
            </div>
          ...
          >
            <div class="rowComp" style={{ marginBottom: "20px" }}>
              ...
              <h3 style={{ marginTop: "10px", marginBottom: "10px" }}>{filterFunction().vacancies[1].jobTitle}</h3>

              <div className="compDesc">
                <p style={{ marginTop: "10px", }}>{filterFunction().vacancies[1].jobDescription}</p>
              </div>
            </div>
