...
function App() {
  ...
  const getProfileData = async () => {
    try {
      ...
      const res = await axios.get(
        "http://127.0.0.1:4000/trainee/dc1ac1002b92436dc4c010b2"
      );
  ...
  const updateData = async (data) => {
    try {
      await axios.put(
        "http://127.0.0.1:4000/trainee/dc1ac1002b92436dc4c010b2/edit",
        data
      );
    } catch (e) {
      console.log(e);
      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/register"
            exact
            element={<Registration registration={true} />}
          />
          <Route
            path="/login"
            exact
            element={<Registration registration={false} />}
          />
